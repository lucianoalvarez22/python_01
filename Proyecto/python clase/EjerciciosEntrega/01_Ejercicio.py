...
def validacion_negativo():
    usuario_edad = int(input("Introduce tu edad: "))
    while usuario_edad < 0:
        usuario_edad = int(input("Has introducido una edad errónea, vuelve a introducir tu edad: "))
    return usuario_edad

edad = validacion_negativo()
